...
class NetworkCheckLog(models.Model):
    ...
    checked_at = models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Waktu Pengecekan')
    ...
    class Meta:
        ...
        ordering = ['-checked_at']
        indexes = [
            models.Index(fields=['checked_by', '-checked_at'], name='network_user_checked_idx'),
        ]
